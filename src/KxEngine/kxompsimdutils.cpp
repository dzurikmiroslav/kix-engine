...
KxOMPSIMDUtils::KxOMPSIMDUtils()
{
}

void KxOMPSIMDUtils::computeIndexedNormals(QVector3D *normals,
...
void KxOMPSIMDUtils::computeIndexedTangents(QVector3D *tangents, const QVector3D *vertices,
...
void KxOMPSIMDUtils::normalize(QVector3D *vectors, int count)
{
#pragma omp parallel for
...
void KxOMPSIMDUtils::computeNormals(QVector3D *normals, const QVector3D *vertices, int count)
{
#pragma omp parallel for
...
void KxOMPSIMDUtils::computeTangents(QVector3D *tangents, const QVector3D *vertices, const QVector3D *normals,
...
void KxOMPSIMDUtils::interpolateJoints(KxTransform *joints,
...
void KxOMPSIMDUtils::computWeightNormalsTangents(KxMd5ModelMeshWeight *weights, int weightCount,
...
void KxOMPSIMDUtils::applyJoints(QVector3D *vertices, QVector3D *normals, QVector3D *tangents,
                                 const KxMd5ModelMeshVertexInfo *infos, int vertexCount,
